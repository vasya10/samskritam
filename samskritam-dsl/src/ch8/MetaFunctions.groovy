...
def script = loadConfig(ch8.config.Script)
def vRtti = loadConfig(ch8.config.Vrutti)
def akshara = loadConfig(ch8.config.Akshara)

def t = script.NativeScript.t
def Tokens = script.Tokens
def DefaultScriptScheme = new NativeScriptScheme() //Script.NativeScript.scheme

def GanaScheme = vRtti.Gana
...
* @ch8 #tasya lopaH
*/
String.metaClass.tasyaLopah = { itRules.tasya_lopaH(delegate) }
...
*/
String.metaClass.svara = { delegate in akshara.svara }
...
* @result boolean
*/
String.metaClass.anusvara = { delegate in akshara.anusvara }
...
* @result boolean
*/
String.metaClass.visarga = { delegate in akshara.visarga }
...
/**
* @metamethod does word/syllable start with vowel?
* @given string word/syllable
* @result boolean
*/
String.metaClass.startsWithSvara = { delegate.varnas().first() in akshara.svara }
...
* @result boolean
*/
String.metaClass.startsWithVyanjana = { !delegate.startsWithSvara }

/**
* @metamethod does word/syllable end with vowel?
* @given string word/syllable
* @result boolean
* @ch8 #ajantaH
*/
String.metaClass.endsWithSvara = { delegate.varnas().last() in akshara.svara }
...
/**
* @metamethod first varna of the word/syllable
* @given string word/syllable
* @result string
* @ch8
*/
String.metaClass.firstVarna = { delegate.varnas().first() }

/**
* @metamethod last varna of the word/syllable
* @given string word/syllable
* @result string
* @ch8
*/
String.metaClass.lastVarna = { delegate.varnas().last() }
...
*/
String.metaClass.hrasva = { delegate in akshara.hrasva }
...
* @ch8 #hrasva dIrgha pluta
*/
String.metaClass.dIrgha = { delegate in akshara.dIrgha }
